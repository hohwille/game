...
import io.github.ghosthopper.object.GameObject;
...
public interface GameChoice<O> extends GameObject {
  ...
  /** The default {@link io.github.ghosthopper.type.GameType#getTypeName() type name} for a {@link GameChoice}. */
   ...
   *         {@link io.github.ghosthopper.i18n.GameTranslator#translate(String) localized} and used as additional info
   ...
   *         {@link io.github.ghosthopper.i18n.GameTranslator#translate(String) localized}).
   */
